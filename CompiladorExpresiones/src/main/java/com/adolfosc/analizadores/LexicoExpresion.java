...
public class LexicoExpresion implements java_cup.runtime.Scanner {
	...
	public LexicoExpresion (java.io.Reader reader) {
		this ();
		if (null == reader) {
	...
	public LexicoExpresion (java.io.InputStream instream) {
		this ();
		if (null == instream) {
			throw (new Error("Error: Bad input stream initializer."));
		}
